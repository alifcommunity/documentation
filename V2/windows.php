    ...
    <main class="main">
        ...
        <div class="col-md-6">
                <div class="card">
                    ...
                    <br><br>
                    <ol>
                    <li>تحميل <a href="https://www.aliflang.org/alifstudio/Alif_Studio.msi" target="_blank">ألف ستوديو</a></li>
                    <li>تنفيذ البرنامج بعد التحميل</li>
                    <li>الذهاب إلى قائمة البرامج و تنفيذ ألف ستوديو</li>
                    </ol>

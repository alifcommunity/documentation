    ...
    <main class="main">
        ...
        <div class="col-md-6">
                <div class="card">
                    ...
                    لبرمجة تطبيقات بلغة ألف على نظام ماك أوس يكفي تحميل و تثبيت بيئة التطوير المتكاملة ألف ستوديو، الرجاء إتباع الخطوات الثالية: 
                    <br><br>
                    <ol>
                    <li>تحميل <a href="https://www.aliflang.org/download" target="_blank">ألف ستوديو</a></li>
                    <li>فك الضغط بعد التحميل</li>
                    <li>تثبيت تلاثة حزم Alif Studio و Library و Compiler</li>
                    </ol>

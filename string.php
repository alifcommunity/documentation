...
<head>
    ...
    <title>المتغيرات النصية - وثائق لغة البرمجة العربية ألف</title>
    ...
    <main class="main">
        ...
        <div class="col-md-6">
                <div class="card">
                    ...
                    المتغير النصي (السلاسل النصية) في لغة ألف هو متغير لاحتواء النصوص والحروف بالعربية أو أية لغة أخرى في جدول اليونيكود (حوالي 1.112.064 حرف ممكن)، ترميزه في الذاكرة يختلف حسب نظام التشغيل، في نظام الويندوز يكون الترميز 16 بت (أي 2 بايت لكل حرف)، بينما في نظام لينكس و ماك أوس يكون الترميز 32 بت (أي 4 بايت لكل حرف)، لكن رغم الإختلاف في الترميز فإن المبرمج لا يلاحظ أي فرق لأن نفس شيفرة ألف تعمل في كل أنظمة التشغيل من دون الحاجة إلى التغيير.
                    <br><br>
                    للإعلان و إنشاء متغير نصي نستعمل الكلمة المفتاحية: <b>نص</b>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <strong>مثال: المتغيرات النصية (السلاسل النصية)</strong>
                    </div>
                    <div class="card-block" style="text-align: justify;text-justify: inter-word;">
<pre><code>
#ألف
